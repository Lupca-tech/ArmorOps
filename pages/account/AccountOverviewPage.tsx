    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="p-6 bg-gray-950 rounded-lg border border-gray-800">
                <h3 className="text-lg font-semibold mb-4 border-b border-gray-800 pb-3">Teams</h3>
                <p className="text-sm text-gray-400 mb-4">The teams that are associated with your Vercel account.</p>
                 <div className="relative">
                    <input type="search" placeholder="Search for a team..." className="w-full bg-black border border-gray-700 rounded-md py-2 pl-10 pr-4 text-white focus:ring-cyan-500 focus:border-cyan-500" />
                ...
                <div className="mt-4 flex items-center justify-between p-3 bg-gray-900/50 rounded-md hover:bg-gray-800/50 transition-colors">
                    <div className="flex items-center gap-3">
                         ...
                         <span className="font-medium">{user.email?.split('@')[0]}'s projects</span>
                    </div>
                     <div className="flex items-center gap-4">
                        <span className="text-xs font-medium text-gray-400 bg-gray-800 px-2 py-1 rounded-full">Hobby</span>
